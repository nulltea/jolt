...
mod test {
    ...
    #[test]
    fn mulu_mle_full_hypercube() {
        instruction_mle_full_hypercube_test::<Fr, MULUInstruction<8>>();
    }

    #[test]
    fn mulu_mle_random() {
        instruction_mle_random_test::<Fr, MULUInstruction<32>>();
    }
    ...
    fn mulu_instruction_32_e2e() {
        ...
        for _ in 0..256 {
            ...
            let instruction = MULUInstruction::<WORD_SIZE>(x, y);
        ...
        let instructions = vec![
            MULUInstruction::<WORD_SIZE>(100, 0),
            MULUInstruction::<WORD_SIZE>(0, 100),
            MULUInstruction::<WORD_SIZE>(1, 0),
            MULUInstruction::<WORD_SIZE>(0, u32_max),
            MULUInstruction::<WORD_SIZE>(u32_max, 0),
            MULUInstruction::<WORD_SIZE>(u32_max, u32_max),
            MULUInstruction::<WORD_SIZE>(u32_max, 1 << 8),
            MULUInstruction::<WORD_SIZE>(1 << 8, u32_max),
        ];
    ...
    fn mulu_instruction_64_e2e() {
        ...
        let instructions = vec![
            ...
            MULUInstruction::<WORD_SIZE>(0, 100),
            MULUInstruction::<WORD_SIZE>(1, 0),
            MULUInstruction::<WORD_SIZE>(0, u64_max),
            MULUInstruction::<WORD_SIZE>(u64_max, 0),
            MULUInstruction::<WORD_SIZE>(u64_max, u64_max),
            MULUInstruction::<WORD_SIZE>(u64_max, 1 << 32),
            MULUInstruction::<WORD_SIZE>(1 << 32, u64_max),
            MULUInstruction::<WORD_SIZE>(1 << 63, 1),
            MULUInstruction::<WORD_SIZE>(1, 1 << 63),
            MULUInstruction::<WORD_SIZE>(u64_max - 1, 1),
            MULUInstruction::<WORD_SIZE>(1, u64_max - 1),
        ];
        for instruction in instructions {
            jolt_instruction_test!(instruction);
        }
